...
**Location**: `node/backend/src/database/seed.sql` (lines 36 and 39)
...
**Location**: `node/frontend/src/pages/Episodes.js` (lines 76-84)
**Type**: Logic Bug
...
**Location**: `node/backend/src/index.js` (lines 30-34)
**Type**: API Design Bug
...
**Location**: `node/backend/src/routes/characters.js` (lines 10-45)
...
**Location**: `node/backend/src/routes/characters.js` (lines 158-168)
**Type**: Error Handling Bug
...
**Location**: `node/backend/src/routes/auth.js` (line 27)
**Type**: Security Bug
...
**Location**: `node/backend/src/database/seed.sql` (line 65)
...
**Location**: `node/frontend/src/pages/` and `node/frontend/src/components/`
...
**Location**: `node/backend/src/routes/episodes.js`
**Type**: Code Style Inconsistency
...
**Location**: `node/backend/src/index.js` (lines 23-27)
**Type**: Code Style
...
**Location**: `node/backend/src/routes/characters.js` (line 113)
**Type**: Security Bug
...
### 20. **CORS Wide Open**
**Location**: `node/backend/src/index.js` (line 13)
...
**Location**: `node/backend/src/routes/auth.js` (lines 175-199)
...
**Location**: `node/backend/src/routes/auth.js` (lines 166-171)
**Type**: Implementation Gap
...
**Location**: `node/backend/src/index.js` (lines 17-20)
...
**Location**: `node/backend/src/routes/characters.js` (line 38)
...
**Location**: `node/backend/src/database/connection.js`
...
**Location**: `node/backend/src/database/connection.js` (lines 42-49)
**Type**: Code Quality
...
**Location**: `node/backend/src/database/connection.js` (lines 35-39)
...
**Location**: `node/frontend/src/components/EpisodeList.js` (lines 84-92)
**Type**: Performance
...
**Location**: `node/backend/src/database/seed.sql`
**Type**: Code Style
...
**Location**: `node/frontend/src/components/Footer.js` (lines 44-48)
...
**Location**: `node/frontend/src/pages/Home.jsx` (line 123)
**Type**: UX Gap
...
**Location**: `node/backend/` and `node/frontend/`
**Type**: Deployment Gap
...
### 40. **No Favicon**
**Location**: `node/frontend/public/index.html` (line 9)

### 41. **No Dark Mode**
**Location**: `node/frontend/src/styles/global.css` (line 43)

### 42. **No Responsive Design**
**Location**: `node/frontend/src/styles/global.css` (line 44)

### 43. **No Character Detail Page**
**Location**: `node/frontend/src/pages/Characters.jsx` (line 137)

### 44. **No Episode Detail Page**
**Location**: `node/frontend/src/pages/Episodes.js` (line 137)
