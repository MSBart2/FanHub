...
-- Link characters to episodes (sample — Walt and Jesse in Season 1 episodes)
...
-- Insert quotes
-- Note: episode IDs here assume inserts above produced IDs 1–62 in order.
-- id 1=S1E1, id 2=S1E2, id 4=S1E4, id 5=S1E5, id 46=S4E13, id 53=S5E7 Say My Name
